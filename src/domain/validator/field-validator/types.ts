...
import { RecursiveDtoFieldValidator } from './recursive-dto-field-validator.ts';
...
type GetValidator<NAME extends string, REQ extends boolean, IS_ARR extends boolean, TYPE> =
    TYPE extends DTO
      ? DtoFieldValidator<NAME, REQ, IS_ARR, TYPE> | RecursiveDtoFieldValidator<NAME, REQ, IS_ARR, DTO>
...
export type ValidatorMap<DTO_TYPE extends DTO | undefined> = {
  [KEY in keyof DTO_TYPE & string]-?: unknown extends DTO_TYPE[KEY]
    ? (
      ...
      | DtoFieldValidator<KEY, boolean, boolean, DTO> | RecursiveDtoFieldValidator<KEY, boolean, boolean, DTO>
    )
