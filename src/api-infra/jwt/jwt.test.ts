...
import { ServerResolveRRR } from '../../api/server/s-resolves.js';
...
function getJwtFakeResolver(
...
): ServerResolver<ServerResolveRRR<TestJwtPayload>> {
  ...
  } as unknown as ServerResolver<ServerResolveRRR<TestJwtPayload>>;
