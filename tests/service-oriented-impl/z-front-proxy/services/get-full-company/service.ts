...
import { QueryService } from '../../../../../src/api/service/concrete-uc/query.uc.js;
...
> {
  ...
  protected async getFullCompany(
    companyId: UuidType, domainUser: AuthUser,
  ): Promise<ServiceResult<GetFullCompanyServiceParams>> {
  ...
  protected async getFullUsers(userIds: UserId[], domainUser: AuthUser): Promise<FullUser[]> {
