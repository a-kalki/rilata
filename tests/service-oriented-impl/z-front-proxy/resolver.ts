...
import { ServerResolveRRR } from '../../../src/api/server/s-resolves.js';
...
export class FrontendProxyModuleResolver extends ModuleResolver<
  ServerResolver<ServerResolveRRR<UserJwtPayload>>, FrontendProxyResolves
> {
  init(
    module: FrontProxyModule,
    serverResolver: ServerResolver<ServerResolveRRR<UserJwtPayload>>,
  ): void {
    this.module = module;
