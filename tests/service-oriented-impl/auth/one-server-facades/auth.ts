import { AuthUser, ModuleCaller } from '../../../../src/api/controller/types.js';
...
export class AuthFacadeOneServerImpl implements AuthFacade {
  ...
  addUser(iin: string, caller: AuthUser): Promise<FullServiceResult<AddingUserService>> {
  ...
  async getUsers(
    userIds: UserId[], caller: AuthUser,
